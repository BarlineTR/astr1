...
class SocialGazeNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("max_velocity_deg_s", 20.0)
        self.declare_parameter("max_acceleration_deg_s2", 40.0)
        self.declare_parameter("max_jerk_deg_s3", 100.0)
        self.declare_parameter("gaze_deadband_deg", 3.5)
