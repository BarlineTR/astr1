...
class GazeTracker:
    ...
    def __init__(self, calibration: Optional[CalibrationConfig] = None):
        ...
        self.fusion = AudioVisualFusionCore(
            ...
            # DSP DOA (GCC-PHAT) is unreliable on this hardware: measured bearings
            # saturate at 0/90/180/270 degrees regardless of actual source direction.
            # Audio still reinforces a confirmed visual target (FUSED modality, ±25°
            # spatial gate) but must never drive the head to a raw DSP bearing alone.
